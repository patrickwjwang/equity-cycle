...
1. Recovery & Expansion: I took the union of factors
2. Downturn: I handpicked factors
3. Depression: I took the intersect of factors
...
# expansion_factors <- intersect(expansion_low_factors, intersect(expansion_med_factors, expansion_high_factors))
...
# downturn_factors <- intersect(downturn_low_factors, intersect(downturn_med_factors, downturn_high_factors))
# downturn_factors <- gsub("\`", "", downturn_factors)
# print(paste0("Downturn Factors: ", paste0(downturn_factors, collapse = ", ")))
downturn_factors <- c('CRD', 'LIQ', 'Mkt-RF', 'RMW', 'SMB', 'IA', 'HML')
...
depression_factors <- intersect(depression_low_factors, intersect(depression_med_factors, depression_high_factors))
